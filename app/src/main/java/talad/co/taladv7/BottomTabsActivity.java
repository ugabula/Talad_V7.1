...
import talad.co.taladv7.fragment.OngoingFragment;
import talad.co.taladv7.fragment.ScheduleFragment;
...
//        toolbar.setTitle("Ongoing");
    ...
    private void setupSetMessage() {
        ImageButton btnCall = (ImageButton) findViewById(R.id.imageButton2);
        btnCall.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager manager = getSupportFragmentManager();
                OngoingFragment dialog = new OngoingFragment();
                dialog.show(manager, " ");

                Log.i("TAG", "WTF this works");
            }
        });
    }
