...
/**
 * Created by cvanderhaar on 2018/08/15.
 */
...
import talad.co.taladv7.ChooseContractor;
...
public class MapSearchActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServicesAvailable()) {
            Toast.makeText(this, "TALAD!!!", Toast.LENGTH_LONG).show();
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent book = new Intent(MapSearchActivity.this, ChooseContractor.class);
                startActivity(book);
            }
        });
    }
        ...
        if(mGoogleMap != null){
            mGoogleMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                ...
                public void onMapLongClick(LatLng latLng) {
                    MapSearchActivity.this.setMarker("Local", latLng.latitude, latLng.longitude);
                }
            });
            ...
            mGoogleMap.setOnMarkerDragListener(new GoogleMap.OnMarkerDragListener() {
                ...
                public void onMarkerDragEnd(Marker marker) {
                    ...
                    Geocoder gc = new Geocoder(MapSearchActivity.this);
...
//        mGoogleApiClient.connect();
    ...
    //Code for the bitmap icon error when you add marker call this method.
...
//        }
        ...
        MarkerOptions options = new MarkerOptions()
                .title(locality)
                .draggable(true)
                .icon(bitmapDescriptorFromVector(this, R.mipmap.ic_farmer_locator))
                .position(new LatLng(lat, lng))
                .snippet("LONG PRESS TO DRAG PIN!!");
