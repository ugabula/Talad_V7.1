...
import talad.co.taladv7.util.Constants;
import talad.co.taladv7.view.DrawingPanel;
import talad.co.taladv7.view.MapFragment;
import talad.co.taladv7.R;

import static talad.co.taladv7.R.id.map;
